class CreateBigcommerceOrders < ActiveRecord::Migration
  def change
    create_table :bigcommerce_orders do |t|
      	  ...
      	  t.integer :coupon_id, unsigned: true, index: true
          ...
          t.string :xero_invoice_id, :xero_invoice_number, limit: 36, index: true
