class CreateXeroCalculations < ActiveRecord::Migration
  def change
    create_table :xero_calculations do |t|
      ...
      :discounted_ex_taxes_unit_price, :wet_unadjusted_order_product_price, :wet_unadjusted_total,\
      :ship_deduction, :subtotal_ex_gst, :wet_adjusted, :adjustment, precision: 10, scale: 4 
      t.decimal :line_amounts_total_ex_taxes, :shipping_ex_gst, :total_ex_gst, :gst,\
