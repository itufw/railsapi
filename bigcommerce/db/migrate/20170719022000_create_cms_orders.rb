class CreateCmsOrders < ActiveRecord::Migration
  def change
    create_table :cms_orders do |t|
      ...
      t.decimal :total_inc_tax, :refunded_amount, scale: 2, precision: 8
      ...
      t.decimal :discount_rate, :discount_amount, :subtotal_ex_tax, :subtotal_inc_tax,
