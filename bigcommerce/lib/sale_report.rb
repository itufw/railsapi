module SaleReport
    ...
    # returns a collection of sale figures and predicting data of
    # a given staff to whom sale figures reports
    # @params:
    #   - staffs : a staff's id to which sale figures report
    # it returns:
    #   - an array of data sets generated by get_sales_data and 
    #     get_projecting_data. Read comment of each method for details
    def genereate_sale_report_data staffs
      ...
      q_lines = get_sales_data quarterly, num_quarter, to_date, staffs, :count_product_lines
      q_qty = get_sales_data quarterly, num_quarter, to_date, staffs, :sum_qty
      q_avg_luc = get_sales_data quarterly, num_quarter, to_date, staffs, :avg_luc
    ...
    # this method generate sale figures according to
    # @params
    #   - frequency   : how often sale figures need to be generated, i.e 
    #                   weekly, monthly, quarterly or yearly
    #   - freq_count  : how many consecutive periods need to be generated
    #   - to_date     : the latest date to which the sale figures need 
    #                   to be generated.
    #   - staffs      : staffs to whom sale orders report to
    #                   i.e candice data is reported to Amy
    #   - agg_func    : aggregate function used to generated the data
    # it turns
    # [
    #   {
    #     [4, 2017]=>[Sun, 01 Oct 2017, Mon, 01 Jan 2018], 
    #     [1, 2018]=>[Mon, 01 Jan 2018, Sun, 01 Apr 2018], 
    #     [2, 2018]=>[Sun, 01 Apr 2018, Sun, 01 Jul 2018], 
    #     [3, 2018]=>[Sun, 01 Jul 2018, Fri, 20 Jul 2018]
    #   }, 
    #   {
    #     ["360 Bar & Dining", 1, 2018]=>2, 
    #     ["360 Bar & Dining", 2, 2018]=>7, 
    #     ["360 Bar & Dining", 3, 2018]=>3, 
    #     ["360 Bar & Dining", 4, 2017]=>6, 
    #     ["Alegrias Spanish Tapas", 1, 2018]=>5, 
    #     ["Alegrias Spanish Tapas", 2, 2018]=>3, 
    #     ["Alegrias Spanish Tapas", 4, 2017]=>4, 
    #     ["Bah BQ", 1, 2018]=>1, 
    #     ["Balcon by Tapavino", 1, 2018]=>2, 
    #     ["Balcon by Tapavino", 2, 2018]=>1, 
    #     ["Balcon by Tapavino", 4, 2017]=>1, 
    #   }
    # ]
    def get_sales_data frequency, freq_count, to_date, staffs, agg_func
