class XeroCalculation < ActiveRecord::Base
	...
	def self.insert_rounding(invoice_number, line_amounts_total_ex_taxes,\
		...
		create(invoice_number: invoice_number, item_code: "ROUNDING", description: "ROUNDING",\
			qty: 1, discounted_ex_taxes_unit_price: rounding_error,\
			line_amount_ex_taxes: line_amounts_total_ex_taxes,\
			line_amount_ex_taxes_rounded: line_amounts_total_ex_taxes_rounded,\
	...
	def self.insert_line_items_ws(invoice_number, product_id, product_name, qty, op_unit_price,\
		...
		clean_product_name = ActiveSupport::Inflector.transliterate(product_name).gsub(/[^a-z ]/i, '')
	...
	def self.insert_line_items_retail(invoice_number, product_id, product_name, qty,\
		...
		line_amount_ex_taxes, line_amount_ex_taxes_rounded, order_total)
