...
class OrderProduct < ActiveRecord::Base
	...
	def stock_change
		...
		Bigcommerce::Product.update(self.product_id, inventory_level: Bigcommerce::Product.find(self.product_id) - self.stock_incremental) if (self.stock_incremental != 0)
	end
