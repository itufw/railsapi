...
class CustomerController < ApplicationController
  ...
  def zomato
    @selected_cuisine = params[:selected_cuisine] || []
    ...
    @zomato = ZomatoRestaurant.unassigned.cuisine_search(@selected_cuisine).search_for(@search_text).send(order_function, direction).paginate(per_page: @per_page, page: params[:page])
  end
